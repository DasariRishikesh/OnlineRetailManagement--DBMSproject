        ...
        <div id="dash_users_body" class="collapsible-body">
          <ul>
            ...
            <li id="users_customer">
              <a class="waves-effect" style="text-decoration: none;" href="../add products/addproducts.php">Add Products</a>
            </li>
          </ul>
        </div>
      </li>
        ...
        <div id="dash_products_body" class="collapsible-body">
          <ul>
            <li id="products_product">
              <a class="waves-effect" style="text-decoration: none;" href="../inventory.php">Products</a>
      ...
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            ...
            <a href="../add products/addproducts.php">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                <i class="indigo-text text-lighten-1 large material-icons">view_list</i>
                <span class="truncate indigo-text text-lighten-1"><h5>Add Products</h5>New products </span>
              </div>
            </a>
          </div>
        </div>
